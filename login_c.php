...
<div id="contents">
	...
	<script type="text/javascript" >
		...
		function check(thisFrm)
		{
			...
			with(thisFrm)
			{
				if(!checkBlnk(ltxt,"User ID field cant be left blank"))
				{
						return false;
				}
...
<tr>
<td width="40%"><h3>USER ID</h3><td><input type="text" name="uid" size=3 />
</tr>
<tr>
<td width="40%"><h3>PASSWORD</h3><td><input type="password" name="pwd" size=12/>
</tr>
<tr>
<td>&nbsp;<td><input type="submit" name="submit" value="LOGIN" onclick="return check(login_c)"/>
</tr>
<tr>
