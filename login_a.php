...
<div id="contents">
	...
	<script type="text/javascript" >
		...
		function check(thisFrm)
		{
			...
			with(thisFrm)
			{
				if(!checkBlnk(ltxt,"Admin ID field cant be left blank"))
				{
						return false;
				}
...
<br>
<br>
<form name="login" method="post" action="process_login_admin.php">
<table border="0" align="center"  cellspacing="2">
<tr>
<td width="40%"><h3>ADMIN ID</h3><td><input type="text" name="aid" size=3 />
</tr>
<tr>
<td width="40%"><h3>PASSWORD</h3><td><input type="password" name="pwd" size=12/>
</tr>
<tr>
<td>&nbsp;<td><input type="submit" name="submita" value="LOGIN" onclick="return check(login_a)"/>
</tr>
<tr>
